  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 flex justify-center bg-transparent max-[1439px]:px-[clamp(0.75rem,2.5vw,1.25rem)] sm:max-[1439px]:px-[clamp(1rem,3vw,1.5rem)]">
      <div className="landing-header-bar w-full max-w-[min(100%,var(--site-content-max))] border-b-4 border-foreground bg-background py-3 pl-4 pr-4 sm:py-4 sm:pl-8 sm:pr-6 md:pl-10 md:pr-8 lg:pl-[60px] lg:pr-[60px]">
        <div className="flex w-full min-w-0 flex-col items-end justify-center gap-3 min-[424px]:flex-row min-[424px]:flex-nowrap min-[424px]:items-center min-[424px]:justify-between min-[424px]:gap-x-2 min-[424px]:gap-y-0 lg:grid lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] lg:items-center lg:gap-3">
          <div className="hidden lg:block" aria-hidden="true" />
          <nav
            className="hidden min-[491px]:flex min-w-0 flex-wrap items-center justify-center gap-x-2 gap-y-1 min-[491px]:min-w-0 min-[491px]:flex-1 min-[491px]:flex-nowrap min-[491px]:justify-start sm:gap-x-3 lg:max-w-none lg:flex-nowrap lg:justify-center lg:gap-x-4 xl:gap-x-6"
            aria-label="Primary"
          >
            {navItems.map((item) => (
              <a
          ...
          <div className="flex w-full shrink-0 flex-nowrap items-center justify-end gap-2 min-[424px]:ml-auto min-[424px]:w-auto min-[424px]:shrink-0 sm:gap-3 lg:ml-0 lg:justify-self-end lg:gap-4">
